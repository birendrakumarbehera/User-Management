<div >
	<div class="icon-bar" style="width: 10%;position: relative;">
  <a class="active" href="dashboard.php"><i class="fa fa-home fa-sm" title="Home"><span style="font-size:18px"> Home</span></i></a> 
